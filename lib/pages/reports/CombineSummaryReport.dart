...
class CombineSummaryReportPage extends StatefulWidget {
  const CombineSummaryReportPage({Key? key}) : super(key: key);

  @override
  _CombineSummaryReportPageState createState() => _CombineSummaryReportPageState();
}

class _CombineSummaryReportPageState extends State<CombineSummaryReportPage> with SingleTickerProviderStateMixin{
