...
class HospitalCallReportPage extends StatefulWidget {
  const HospitalCallReportPage({Key? key}) : super(key: key);

  @override
  _HospitalCallReportPageState createState() => _HospitalCallReportPageState();
}

class _HospitalCallReportPageState extends State<HospitalCallReportPage> with SingleTickerProviderStateMixin{
