...
class FirmDailyCallReportPage extends StatefulWidget {
  const FirmDailyCallReportPage({Key? key}) : super(key: key);

  @override
  _FirmDailyCallReportPageState createState() => _FirmDailyCallReportPageState();
}

class _FirmDailyCallReportPageState extends State<FirmDailyCallReportPage> with SingleTickerProviderStateMixin{
