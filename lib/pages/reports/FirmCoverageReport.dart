...
class FirmCoverageReportPage extends StatefulWidget {
  const FirmCoverageReportPage({Key? key}) : super(key: key);

  @override
  _FirmCoverageReportPageState createState() => _FirmCoverageReportPageState();
}

class _FirmCoverageReportPageState extends State<FirmCoverageReportPage> {
  ...
  final List<String> categories = ['All Category', 'Retailer', 'Stockist', 'Distributor'];

  final List<Map<String, String>> reportData = [
    {'Name': 'Amit Pharma', 'city': 'Amravati', 'days': '20', 'count': '15','Category':'Stockist'},
    {'Name': 'Jane Medical', 'city': 'Pune', 'days': '18', 'count': '12','Category':'Retailer'},
