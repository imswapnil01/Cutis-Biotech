...
class DailyWorkRecordPage extends StatefulWidget {
  const DailyWorkRecordPage({Key? key}) : super(key: key);

  @override
  _DailyWorkRecordPageState createState() => _DailyWorkRecordPageState();
}

class _DailyWorkRecordPageState extends State<DailyWorkRecordPage> {
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: fromDate.isEmpty ? 'Select Date' : fromDate,
                          hintStyle: TextStyle(
