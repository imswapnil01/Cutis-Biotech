...
class DoctorBusinessReportPage extends StatefulWidget {
  const DoctorBusinessReportPage({Key? key}) : super(key: key);

  @override
  _DoctorBusinessReportPageState createState() => _DoctorBusinessReportPageState();
}

class _DoctorBusinessReportPageState extends State<DoctorBusinessReportPage> {
